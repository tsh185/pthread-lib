...
/**
 * @brief Get the name of a heap.
 * @note Complexity: O( 1 )
 * @pre H must be a valid gdsl_heap_t
 * @post The returned string MUST NOT be freed.
 * @param H The heap to get the name from
 * @return the name of the heap H.
 * @see gdsl_heap_set_name()
 */
extern const char*
gdsl_heap_get_name (const gdsl_heap_t H
		    );
...
/**
 * @brief Set the name of a heap.
 *
 * Change the previous name of the heap H to a copy of NEW_NAME.
 * 
 * @note Complexity: O( 1 )
 * @pre H must be a valid gdsl_heap_t
 * @param H The heap to change the name
 * @param NEW_NAME The new name of H
 * @return the modified heap in case of success.
 * @return NULL in case of insufficient memory.
 * @see gdsl_heap_get_name()
 */
extern gdsl_heap_t
gdsl_heap_set_name (gdsl_heap_t H,
		    const char* NEW_NAME
		    );
...
/**
 * @brief Write the content of a heap to a file into XML.
 *
 * Write the elements of the heap H to OUTPUT_FILE, into XML language.
 ...
 */
extern void
gdsl_heap_write_xml (const gdsl_heap_t H,
		     gdsl_write_func_t WRITE_F,
		     FILE* OUTPUT_FILE,
		     void* USER_DATA
		     );
