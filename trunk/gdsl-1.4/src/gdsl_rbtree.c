		     ...
		     gdsl_map_func_t map_f, void* d)
{
    if (root != sent)
	{
	    ...
	    rbtree_prefix_parse (LEFT (root), sent, map_f, d);
	    rbtree_prefix_parse (RIGHT (root), sent, map_f, d);
	}
		    ...
		    gdsl_map_func_t map_f, void* d)
{
    if (root != sent)
	{
	    ...
	    rbtree_infix_parse (LEFT (root), sent, map_f, d);
	    ...
	    rbtree_infix_parse (RIGHT (root), sent, map_f, d);
	}
		      ...
		      gdsl_map_func_t map_f, void* d)
{
    if (root != sent)
	{
	    ...
	    rbtree_postfix_parse (LEFT (root), sent, map_f, d);
	    rbtree_postfix_parse (RIGHT (root), sent, map_f, d);
